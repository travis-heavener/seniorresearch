...
const TermsModal = (props) => {
    ...
    const H3 = (props) => <Text style={styles.h3}>{props.children}</Text>
        ...
        >
            ...
            <ScrollView style={styles.body} overScrollMode="never" showsVerticalScrollIndicator={false}>
                <View style={styles.textContainer}>
                    ...
                    <UL>
                        <LI>
                            <B>Application</B><P> means the software program provided by the Company downloaded by You on any electronic device, named BinGo</P>
                        </LI>
                        <LI>
                            <B>Application Store</B><P> means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.</P>
                        </LI>
                        <LI>
                            <B>Affiliate</B><P> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</P>
                        </LI>
                        <LI>
                            <B>Country</B><P> refers to: Virginia,  United States</P>
                        </LI>
                        <LI>
                            <B>Company</B><P> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BinGo.</P>
                        </LI>
                        <LI>
                            <B>Device</B><P> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</P>
                        </LI>
                        <LI>
                        ...
                        <LI>
                            <B>You</B><P> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</P>
                        </LI>
                    </UL>
                    ...
                    <UL>
                        <LI>By email: travis.heavener@gmail.com</LI>
                    </UL>
