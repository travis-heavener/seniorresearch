        ...
        >
            ...
            <ScrollView style={styles.body} overScrollMode="never" showsVerticalScrollIndicator={false}>
                <View style={styles.textContainer}>
                    ...
                    { generateUL(
                        <P><B>Application</B> means the software program provided by the Company downloaded by You on any electronic device, named BinGo</P>,
                        <P><B>Application Store</B> means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.</P>,
                        ...
                        <P><B>Country</B> refers to: Virginia,  United States</P>,
                        <P><B>Company</B> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BinGo.</P>,
                        ...
                        <P><B>Terms and Conditions</B> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <A href="https://www.termsfeed.com/terms-conditions-generator/">TermsFeed Terms and Conditions Generator</A>.</P>,
